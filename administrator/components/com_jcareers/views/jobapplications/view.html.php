 ...
 */
class JcareersViewJobApplications extends JView
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        $this->params       = JComponentHelper::getParams('com_jcareers');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('Received Applications'), 'jobs.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.'/views/jobapplication';
		...
		if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
			    JToolBarHelper::divider();
			    JToolBarHelper::archiveList('jobapplications.archive','JTOOLBAR_ARCHIVE');
            }
        ...
        if (isset($this->items[0]->state)) {
		    if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
			    JToolBarHelper::deleteList('', 'jobapplications.delete','JTOOLBAR_EMPTY_TRASH');
			    JToolBarHelper::divider();
		    } else if ($canDo->get('core.edit.state')) {
			    JToolBarHelper::trash('jobapplications.trash','JTOOLBAR_TRASH');
			    JToolBarHelper::divider();
		    }
        }
