	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JCAREERS_JOBS_CODE', 'a.code', $listDirn, $listOrder); ?>
				</th>
				
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JCAREERS_JOBS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
				
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JCAREERS_JOBS_TOTAL_POSITIONS', 'a.total_positions', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_JCAREERS_JOBS_TOTAL_APPLICATIONS', 'a.total_applications', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_jcareers&task=job.edit&id='.(int) $item->id); ?>">
				...
				<td>
					<?php 
						if( $item->total_applications > 0 ){
							echo $item->total_applications;
							echo ' (<a href="index.php?option=com_jcareers&view=jobapplications&job_id='.$item->id.'" target="_blank">view</a>)';
						}else{ echo '0'; }  
					?>
				</td>
